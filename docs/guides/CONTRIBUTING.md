...
4. **Add entries to [`CHANGELOG.md`](../releases/CHANGELOG.md)** under "Unreleased" section
...
4. **Update [`CHANGELOG.md`](../releases/CHANGELOG.md)** with dependency changes
...
- [ ] Documentation updated
- [ ] [`CHANGELOG.md`](../releases/CHANGELOG.md) updated
