...
import { Send, Bot, User, Sparkles, TrendingUp, Copy, BarChart3, LineChart, PieChart, ArrowLeft } from 'lucide-react';
...
const initialMessages: Message[] = [
  {
    id: 1,
    role: 'assistant',
    content: "👋 Hi! I'm your HR Analytics Assistant. Ask me questions about your workforce data, and I'll generate insights and visualizations for you.\n\nTry asking:\n- What's our department distribution?\n- Show me attrition trends\n- Compare performance ratings by level",
              ...
              >
                ...
                <div className="relative backdrop-blur-2xl bg-black/40 border-2 border-white/30 rounded-3xl flex flex-col h-full overflow-hidden hover:border-white/40 transition-all duration-300">
                  ...
                  <div className="p-6 border-t-2 border-white/20 bg-gradient-to-r from-blue-500/5 to-purple-500/5">
                    ...
                    <p id="analytics-input-help" className="text-xs text-gray-500 mt-2 text-center">
                      Press Enter to send
                    </p>
                  </div>
                </div>
                    ...
                    <>
                      <div className="flex items-center justify-between mb-6">
                        <h3 className="text-lg font-semibold flex items-center gap-2">
                          {currentChart.type === 'bar' && <BarChart3 className="w-5 h-5 text-blue-400" aria-hidden="true" />}
                          {currentChart.type === 'line' && <LineChart className="w-5 h-5 text-purple-400" aria-hidden="true" />}
                          {currentChart.type === 'pie' && <PieChart className="w-5 h-5 text-pink-400" aria-hidden="true" />}
                          Visualization
                        </h3>
                      </div>
