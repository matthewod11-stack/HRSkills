      ...
      return NextResponse.json(
        {
          ...
          error: {
            message:
              'No employee data found. Please upload your employee master sheet in the Data Center first.',
            code: 'NO_DATA',
        ...
        return NextResponse.json(
          {
            ...
            error: {
              message:
                "I couldn't determine how to query your data for that question. Could you be more specific?",
